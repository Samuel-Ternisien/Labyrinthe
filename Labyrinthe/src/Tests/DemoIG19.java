...
public class DemoIG19 {
    ...
    public static void main(String[] args) {
        ...
        // Saisie des différents paramétres
        Object parametres[];
        parametres=IG.saisirParametres(); // On ouvre la fenétre de paramétrage pour la saisie

        // Création de la fenétre de jeu et affichage de la fenétre
        int nbJoueurs=((Integer)parametres[0]).intValue(); // RécupÃ©ration du nombre de joueurs
        IG.creerFenetreJeu("Démo Librairie IG version 1.9",nbJoueurs); // On crée la fenétre
        ...
        IG.afficherMessage(message); // On change de message de la fenétre de jeu
        IG.miseAJourAffichage(); // On effectue le rafraichissement de la fenétre de jeu
        ...
        // Sélectionne la fléche 3
        IG.selectionnerFleche(3);
        IG.miseAJourAffichage();
        IG.attendreClic();

        // Sélectionne la piéce sur le plateau à  la ligne 2 colonne 3.
        ...
        message[3]="Puis sélectionner une fléche ...";
        ...
        message[0]="";
        message[1]="Sélectionner une piÃ¨ce sur ";
